...
* **Aggregation:** The process began by merging 4 distinct Excel parts (as seen on the slide) to create a single, comprehensive dataset covering records from 2004 to the present.
